...
public class DrunkGame {
    public static void main(String[] args) {
        ...
        // Создание очередей для карт игроков
        Queue<Integer> player1Deck = parseCards(player1Cards);
        Queue<Integer> player2Deck = parseCards(player2Cards);
    ...
    // Метод для преобразования строки с картами в очередь целых чисел
    private static Queue<Integer> parseCards(String cards) {
